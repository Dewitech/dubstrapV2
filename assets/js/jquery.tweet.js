...
(function (factory) {
	...
	$.fn.tweet = function(o){
		...
		$.fn.extend({
			linkUser: replacer(/(^|[\W])@(\w+)/gi, "$1<col-md- class=\"at\">@</col-md-><a href=\"http://"+s.twitter_url+"/$2\">$2</a>"),
		...
		function extract_template_data(item) {
			...
			// Default col-md-s, and pre-formatted blocks for common layouts
			o.user = t('<a class="tweet_user" href="{user_url}">{screen_name}</a>', o);
			o.join = s.join_text ? t(' <col-md- class="tweet_join">{join_text}</col-md-> ', o) : ' ';
			o.avatar = o.avatar_size ?
				t('<a class="tweet_avatar" href="{user_url}"><img src="{avatar_url}" height="{avatar_size}" width="{avatar_size}" alt="{screen_name}\'s avatar" title="{screen_name}\'s avatar" border="0"/></a>', o) : '';
			o.time = t('<col-md- class="tweet_time"><a href="{tweet_url}" title="view tweet on twitter">{tweet_relative_time}</a></col-md->', o);
			o.text = t('<col-md- class="tweet_text">{tweet_text_fancy}</col-md->', o);
